...
import { passData, passdeleteTodo } from "../action/passdata";
...
function EnhancedTable() {
  ...
  const [rowuserdata, setRowsuserdata] = React.useState();
  ...
  const handleClick = (event, firstname, rowdataid) => {
    dispatch(passData(rowdataid));
    dispatch(passdeleteTodo(rowdataid));
    let userdata = rowdataid;
    console.log(rowuserdata);
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      <TableRow
                        hover
                        onClick={(event) =>
                          handleClick(event, row.id, rowdataid)
                        }
                        role="checkbox"
